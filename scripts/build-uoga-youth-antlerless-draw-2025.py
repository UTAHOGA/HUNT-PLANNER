...
RAW_DATA_DIR = Path(r"C:\UOGA HUNTS\raw_data 2025")
RAW_DATA_DIR_ALT = Path(r"C:\UOGA HUNTS\raw_data_2025")
RAW_DATA_ROOT = RAW_DATA_DIR if RAW_DATA_DIR.exists() else RAW_DATA_DIR_ALT
PDF_PATH = RAW_DATA_ROOT / "25_youth_antlerless_drawing_odds_report.pdf"
OUTPUT_DIR = WORKSPACE_ROOT / "data" / "uoga_youth_antlerless_draw_layers"
PROCESSED_OUTPUT_PATH = UOGA_ROOT / "processed_data" / "youth_antlerless_draw_2025.csv"

RAW_SECTION_PATH = OUTPUT_DIR / "layer_04_youth_antlerless_draw_hunt_sections_raw_2025.jsonl"
CSV_PATH = OUTPUT_DIR / "youth_antlerless_draw_2025.csv"
VALIDATION_PATH = OUTPUT_DIR / "youth_antlerless_draw_2025.validation.json"
ACCEPTANCE_PATH = OUTPUT_DIR / "youth_antlerless_draw_2025.acceptance.json"
STATUS_PATH = OUTPUT_DIR / "youth_antlerless_draw_2025.status.json"

HEADER_RE = re.compile(r"Hunt:\s*([A-Z]{2}\d+)\s+(.*?)\s*$", re.IGNORECASE)
DATA_LINE_RE = re.compile(r"^\s*(?:[0-9]|1[0-5]|Totals)\b")
...
def parse_data_line(line: str) -> list[dict[str, object]]:
    ...
    return [
        {"residency": "Resident", **left},
        {"residency": "Nonresident", **right},
    ]
...
def build() -> dict[str, object]:
    ...
    validation = {
        "table": "youth_antlerless_draw_breakdown",
        "draw_year": 2025,
    ...
    acceptance = {
        ...
        "checks": {
            ...
            "point_level_domain_valid_0_15": point_values == list(range(0, expected_point_levels_per_residency)),
