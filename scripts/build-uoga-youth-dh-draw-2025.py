...
PDF_PATH = RAW_DATA_ROOT / "25_youth_dh_odds.pdf"
OUTPUT_DIR = WORKSPACE_ROOT / "data" / "uoga_youth_dh_draw_layers"
PROCESSED_OUTPUT_PATH = UOGA_ROOT / "processed_data" / "youth_dh_draw_2025.csv"

SECTION_TEXT_PATH = OUTPUT_DIR / "layer_04_youth_dh_draw_hunt_sections_raw_2025.jsonl"
CSV_PATH = OUTPUT_DIR / "youth_dh_draw_2025.csv"
VALIDATION_PATH = OUTPUT_DIR / "youth_dh_draw_2025.validation.json"
ACCEPTANCE_PATH = OUTPUT_DIR / "youth_dh_draw_2025.acceptance.json"
STATUS_PATH = OUTPUT_DIR / "youth_dh_draw_2025.status.json"
