...
PDF_PATH = RAW_DATA_ROOT / "25_antlerless_drawing_odds_report.pdf"
OUTPUT_DIR = WORKSPACE_ROOT / "data" / "uoga_antlerless_draw_layers"
PROCESSED_OUTPUT_PATH = UOGA_ROOT / "processed_data" / "antlerless_draw_2025.csv"

RAW_SECTION_PATH = OUTPUT_DIR / "layer_04_antlerless_draw_hunt_sections_raw_2025.jsonl"
CSV_PATH = OUTPUT_DIR / "antlerless_draw_2025.csv"
VALIDATION_PATH = OUTPUT_DIR / "antlerless_draw_2025.validation.json"
ACCEPTANCE_PATH = OUTPUT_DIR / "antlerless_draw_2025.acceptance.json"
STATUS_PATH = OUTPUT_DIR / "antlerless_draw_2025.status.json"
