...
PDF_PATH = RAW_DATA_ROOT / "25_youth_deer.pdf"
OUTPUT_DIR = WORKSPACE_ROOT / "data" / "uoga_youth_deer_draw_layers"
PROCESSED_OUTPUT_PATH = UOGA_ROOT / "processed_data" / "youth_deer_draw_2025.csv"

SECTION_TEXT_PATH = OUTPUT_DIR / "layer_04_youth_deer_draw_hunt_sections_raw_2025.jsonl"
CSV_PATH = OUTPUT_DIR / "youth_deer_draw_2025.csv"
VALIDATION_PATH = OUTPUT_DIR / "youth_deer_draw_2025.validation.json"
ACCEPTANCE_PATH = OUTPUT_DIR / "youth_deer_draw_2025.acceptance.json"
STATUS_PATH = OUTPUT_DIR / "youth_deer_draw_2025.status.json"

HEADER_RE = re.compile(r"Hunt:\s*([A-Z]{2}\d+)\s+(.*?)\s*$", re.IGNORECASE)
DATA_LINE_RE = re.compile(r"^\s*(?:[0-9]|1[0-9]|2[0-1]|Totals)\b")
VALID_PREFIXES = {"DB"}
...
def build() -> dict[str, object]:
    ...
    validation = {
        "table": "youth_deer_draw_breakdown",
        "draw_year": 2025,
