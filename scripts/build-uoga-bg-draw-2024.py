...
PDF_PATH = RAW_DATA_ROOT / "24_bg-odds.pdf"
OUTPUT_DIR = WORKSPACE_ROOT / "data" / "uoga_bg_draw_layers_2024"
TESSERACT_PATH = Path(r"C:\Program Files\Tesseract-OCR\tesseract.exe")

SECTION_TEXT_PATH = OUTPUT_DIR / "layer_04_bg_draw_hunt_sections_raw_2024.jsonl"
CSV_PATH = OUTPUT_DIR / "draw_breakdown_2024.csv"
VALIDATION_PATH = OUTPUT_DIR / "draw_breakdown_2024.validation.json"
STATUS_PATH = OUTPUT_DIR / "draw_breakdown_2024.status.json"
...
def normalize_ocr_line(line: str) -> str:
    ...
    text = re.sub(r"\b0+\s+N/A\b", "0 N/A", text)
...
def main() -> None:
    ...
    data_rows, duplicate_keys = dedupe_rows(data_rows)
